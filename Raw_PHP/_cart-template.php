        ...
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="row border-top py-3 mt-3">
                    ...
                    <div class="col-sm-8">
                        <h5 class="font-baloo font-size-20">Tomatoes</h5>
                        <small>by Rick Astley</small>
                        <!-- product rating -->
                        <div class="d-flex">
                ...
                <div class="row border-top py-3 mt-3">
                    ...
                    <div class="col-sm-8">
                        <h5 class="font-baloo font-size-20">Bananas</h5>
                        <small>by Rick Astley</small>
                        <!-- product rating -->
                        <div class="d-flex">
                            <div class="rating text-warning font-size-12">
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    ...
                    <div class="border-top py-4">
                        <h5 class="font-baloo font-size-20">Subtotal (2 item):&nbsp; <span class="text-danger">₹<span class="text-danger" id="deal-price">80.00</span> </span> </h5>
