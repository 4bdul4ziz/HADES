...
<body>
    ...
    <header id="header">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark color-primary-bg">
            <a class="navbar-brand" href="#">꧁༒𝐇.𝐀.𝐃.𝐄.𝐒༒꧂</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav m-auto font-rubik">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="#">𝐀𝐥𝐥 𝐂𝐚𝐭𝐞𝐠𝐨𝐫𝐢𝐞𝐬 <i class="fa fa-chevron-circle-down"></i></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">𝐍𝐞𝐚𝐫 𝐘𝐨𝐮</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">𝐁𝐞𝐬𝐭 𝐒𝐞𝐥𝐥𝐞𝐫𝐬</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">𝐇𝐨𝐦𝐞 & 𝐊𝐢𝐭𝐜𝐡𝐞𝐧</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">𝐅𝐫𝐞𝐬𝐡 𝐇𝐚𝐫𝐯𝐞𝐬𝐭𝐬</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">𝐃𝐚𝐢𝐫𝐲 & 𝐏𝐨𝐮𝐥𝐭𝐫𝐲</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">𝐅𝐥𝐚𝐬𝐡 𝐒𝐚𝐥𝐞𝐬</a>
                    </li>
                </ul>
    ...
    <main id="main-site">
        ...
        <section id="on-sale">
            <div class="container py-5">
                <h4 class="font-rubik font-size-20">ᴅᴀɪʀʏ & ᴘᴏᴜʟᴛʀʏ</h4>
                <hr>
                <!-- owl carousel -->
                <div class="owl-carousel owl-theme">
                    <div class="item py-2">
                    ...
                    <div class="item py-2">
                        <div class="product font-rale">
                            <a href="#"><img src="../assets/products/19.png" alt="product1" class="img-fluid"></a>
                            <div class="text-center">
                                <h6>Coconut Milk</h6>
                                <div class="rating text-warning font-size-12">
                                    <span><i class="fas fa-star"></i></span>
                    ...
                    <div class="item py-2">
                        <div class="product font-rale">
                            <a href="#"><img src="../assets/products/20.png" alt="product1" class="img-fluid"></a>
                            <div class="text-center">
                                <h6>Yogurt</h6>
                                <div class="rating text-warning font-size-12">
                                    <span><i class="fas fa-star"></i></span>
                    ...
                    <div class="item py-2">
                        <div class="product font-rale">
                            <a href="#"><img src="../assets/products/17.png" alt="product1" class="img-fluid"></a>
                            <div class="text-center">
                                <h6>Skimmed Milk</h6>
                                <div class="rating text-warning font-size-12">
                                    <span><i class="fas fa-star"></i></span>
                    ...
                    <div class="item py-2">
                        <div class="product font-rale">
                            <a href="#"><img src="../assets/products/21.png" alt="product1" class="img-fluid"></a>
                            <div class="text-center">
                                <h6>Flavoured Milk</h6>
                                <div class="rating text-warning font-size-12">
                                    <span><i class="fas fa-star"></i></span>
                                    <span><i class="fas fa-star"></i></span>
                                    <span><i class="fas fa-star"></i></span>
                    ...
                    <div class="item py-2">
                        <div class="product font-rale">
                            <div class="d-flex flex-column">
                                <a href="#"><img src="../assets/products/22.png" class="img-fluid" alt="pro1"></a>
                                <div class="text-center">
                                    <h6>Almond Milk</h6>
                                    <div class="rating text-warning font-size-12">
                                        <span><i class="fas fa-star"></i></span>
                    ...
                    <div class="item py-2">
                        <div class="product font-rale">
                            <div class="d-flex flex-column">
                                <a href="#"><img src="../assets/products/23.png" class="img-fluid" alt="pro1"></a>
                                <div class="text-center">
                                    <h6>Non-lactose Milk</h6>
                                    <div class="rating text-warning font-size-12">
                                        <span><i class="fas fa-star"></i></span>
                                        <span><i class="fas fa-star"></i></span>
                                        <span><i class="fas fa-star"></i></span>
        ...
        <section id="special-price">
            <div class="container">
                <h4 class="font-rubik font-size-20">ꜰʟᴀꜱʜ ꜱᴀʟᴇꜱ</h4>
                <div id="filters" class="button-group text-right font-baloo font-size-16">
                    <button class="btn is-checked" data-filter="*">All Items</button>
                    <button class="btn" data-filter=".Fruits">Fruits & Vegetables</button>
                    <button class="btn" data-filter=".Dairy">Dairy Products</button>
                    <button class="btn" data-filter=".Essential">Essential Items</button>

                </div>

                <div class="grid">
                    <div class="grid-item Essential Items border">
                    ...
                    <div class="grid-item Fruits & Vegetables border">
                        <div class="item py-2" style="width: 200px;">
                            <div class="product font-rale">
                    ...
                    <div class="grid-item Dairy Products border">
                        <div class="item py-2" style="width: 200px;">
                            <div class="product font-rale">
                                <a href="#"><img src="../assets/products/21.png" alt="product1" class="img-fluid"></a>
                                <div class="text-center">
        ...
        <!-- New Stuff -->
        <section id="fresh-harvests">
            <div class="container">
                <h4 class="font-rubik font-size-20">ɴᴇᴡʟʏ ᴀʀʀɪᴠᴇᴅ</h4>
                <hr>
                ...
                <div class="owl-carousel owl-theme">
                    ...
                    <div class="item py-2 bg-light">
                        <div class="product font-rale">
                            <div class="d-flex flex-column">
                                <a href="#"><img src="../assets/products/8.png" class="img-fluid" alt="pro1"></a>
                                <div class="text-center">
                                    <h6>Butter</h6>
                                    <div class="rating text-warning font-size-12">
                                        <span><i class="fas fa-star"></i></span>
        ...
        <section id="blogs">
            <div class="container py-4">
                <h4 class="font-rubik font-size-28">𝔏𝔞𝔱𝔢𝔰𝔱 𝔅𝔩𝔬𝔤𝔰</h4>
                <hr>

                <div class="owl-carousel owl-theme">
                    <div class="item">
                        <div class="card border-0 font-rale mr-5" style="width: 18rem;">
                            <h5 class="card-title font-size-16">𝗩𝗲𝗴𝗲𝘁𝗮𝗯𝗹𝗲 𝗧𝗶𝗺𝗲𝘀</h5>
                            <img src="../assets/blog/blog1.jpg" alt="cart image" class="card-img-top">
                            <p class="card-text font-size-14 text-black-50 py-1">𝑁𝑒𝑣𝑒𝑟 𝑔𝑜𝑛𝑛𝑎 𝑔𝑖𝑣𝑒 𝑦𝑜𝑢 𝑢𝑝, 𝑁𝑒𝑣𝑒𝑟 𝑔𝑜𝑛𝑛𝑎 𝑙𝑒𝑡 𝑦𝑜𝑢 𝑑𝑜𝑤𝑛, 𝑁𝑒𝑣𝑒𝑟 𝑔𝑜𝑛𝑛𝑎 𝑟𝑢𝑛 𝑎𝑟𝑜𝑢𝑛𝑑 𝑎𝑛𝑑 𝑑𝑒𝑠𝑒𝑟𝑡 𝑦𝑜𝑢, 𝑁𝑒𝑣𝑒𝑟 𝑔𝑜𝑛𝑛𝑎 𝑚𝑎𝑘𝑒 𝑦𝑜𝑢 𝑐𝑟𝑦, 𝑁𝑒𝑣𝑒𝑟 𝑔𝑜𝑛𝑛𝑎 𝑠𝑎𝑦 𝑔𝑜𝑜𝑑𝑏𝑦𝑒, 𝑁𝑒𝑣𝑒𝑟 𝑔𝑜𝑛𝑛𝑎 𝑡𝑒𝑙𝑙 𝑎 𝑙𝑖𝑒 𝑎𝑛𝑑 ℎ𝑢𝑟𝑡 𝑦𝑜𝑢!</p>
                            <a href="#" class="color-second text-left">𝗥𝗲𝗮𝗱 𝗠𝗼𝗿𝗲</a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="card border-0 font-rale mr-5" style="width: 18rem;">
                            <h5 class="card-title font-size-16">𝗗𝗮𝗶𝗿𝘆 𝗙𝗮𝗻𝘁𝗮𝘀𝘆</h5>
                    ...
                    <div class="item">
                        <div class="card border-0 font-rale mr-5" style="width: 18rem;">
                            <h5 class="card-title font-size-16">𝗠𝗲𝗱𝗶𝗰𝗶𝗻𝗮𝗹 𝗠𝘂𝗻𝗰𝗵𝗲𝘀</h5>
    ...
    <div class="copyright text-center bg-dark text-white py-2">
        <p class="font-rale font-size-14">&copy; Copyrights 2021. Design By <a href="#" class="color-second">Abdul Of Team HADES</a></p>
    </div>
    <!-- !start #footer -->
